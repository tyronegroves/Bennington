...
{
    public interface IInstinctSectionRouteHandler : IRouteHandler
    {
    }

    public class InstinctSectionRouteHandler : IInstinctSectionRouteHandler
    {
        private readonly IServiceLocator serviceLocator;

        public InstinctSectionRouteHandler(IServiceLocator serviceLocator)
        {
