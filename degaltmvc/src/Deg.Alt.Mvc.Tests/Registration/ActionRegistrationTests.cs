...
namespace Deg.Alt.Mvc.Tests.Registration
{
    ...
    public class ActionRegistrationTests
    {
        ...
        {
            VerifyThatThisWasRegisteredToThat(typeof(IGetContentItemForPageLocationAction), typeof(GetContentItemForPageLocationAction));
        }

        [TestMethod]
        public void Registers_IGetControllerForPageIdAction()
        {
            VerifyThatThisWasRegisteredToThat(typeof(IGetControllerForPageIdAction), typeof(GetControllerForPageIdAction));
        }

        [TestMethod]
        public void Registers_GetPageAction()
        {
            VerifyThatThisWasRegisteredToThat(typeof(IGetPageAction), typeof(GetPageAction));
        }

        [TestMethod]
        public void Registers_GetPageFromPageLocationAction()
        {
            VerifyThatThisWasRegisteredToThat(typeof(IGetPageForPageLocationAction), typeof(GetPageForPageLocationAction));
        }

        [TestMethod]
        public void Registers_GetPageForRoutingAction()
        {
            VerifyThatThisWasRegisteredToThat(typeof(IGetPageForRoutingAction), typeof(GetPageForRoutingAction));
        }
        ...
        private void VerifyThatThisWasRegisteredToThat(Type @this, Type that)
        {
            ...
            var action = mocker.Resolve<ActionRegistration>();
