...
namespace Bennington.Cms.Tests
{
    ...
    public class PaginationHelpers
    {
        ...
        {
            var paginationRange = new[] {"a", "b"}.ToPagedList(1, 10).GetPageRange(0);
        ...
        {
            var paginationRange = Enumerable.Range(0, 11).ToPagedList(1, 10).GetPageRange(0);
            paginationRange.Begin.ShouldEqual(1);
        ...
        {
            var paginationRange = Enumerable.Range(0, 12).ToPagedList(1, 10).GetPageRange(1);
        ...
        {
            var paginationRange = Enumerable.Range(0, 21).ToPagedList(1, 10).GetPageRange(1);
            paginationRange.Begin.ShouldEqual(11);
        ...
        {
            var paginationRange = Enumerable.Range(0, 21).ToPagedList(1, 10).GetPageRange(3);
        ...
        {
            var paginationRange = Enumerable.Range(0, 2).ToPagedList(1, 10).GetPageRange(0).ToString();
        ...
        {
            var paginationRange = Enumerable.Range(0, 11).ToPagedList(1, 10).GetPageRange(1).ToString();
