...
namespace Paragon.ContentTree.ContentNodeProvider.Data
{
    ...
    partial void InsertContentTreeNode(ContentTreeNode instance);
    partial void UpdateContentTreeNode(ContentTreeNode instance);
    partial void DeleteContentTreeNode(ContentTreeNode instance);
    #endregion
		
		public ContentTreeNodeProviderDataModelDataContext() : 
				base(global::Paragon.ContentTree.ContentNodeProvider.Properties.Settings.Default.ParagonConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<ContentTreeNode> ContentTreeNodes
		{
			get
			{
				return this.GetTable<ContentTreeNode>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ContentTreeNode")]
	public partial class ContentTreeNode : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnContentItemIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ContentItemId", DbType="nvarchar(100)", CanBeNull=false)]
