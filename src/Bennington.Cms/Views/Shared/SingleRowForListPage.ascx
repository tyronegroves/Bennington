...
<%
    ...
    var buttons = ViewData.ModelMetadata.AdditionalValues.ContainsKey("IndividualRowButtons") ? ViewData.ModelMetadata.AdditionalValues["IndividualRowButtons"] as IEnumerable<Bennington.Cms.Buttons.Button> : null;
